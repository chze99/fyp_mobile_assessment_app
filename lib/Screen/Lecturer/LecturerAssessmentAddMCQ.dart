...
class LecturerAssessmentAddMCQ extends StatefulWidget {
  @override
  ...
  _LecturerAssessmentAddMCQState createState() =>
      _LecturerAssessmentAddMCQState();
}

class _LecturerAssessmentAddMCQState extends State<LecturerAssessmentAddMCQ> {
  bool isLoading = true;
  bool isInitial = true;
  ...
  save_mcq() async {
    ...
    var res = await Api().postData(data, "saveMCQQuestion");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body;
  ...
  update_mcq() async {
    ...
    var res = await Api().postData(data, "updateMCQQuestion");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body;
