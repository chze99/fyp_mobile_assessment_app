...
class LecturerViewSubmissionMCQ extends StatefulWidget {
  @override
  int solution_questionpaper_id = 0;
  int solution_paperdetail_id = 0;
  int question_number = 0;
  String mode = '';
  LecturerViewSubmissionMCQ(this.solution_questionpaper_id,
      this.solution_paperdetail_id, this.question_number, this.mode);

  _LecturerViewSubmissionMCQState createState() =>
      _LecturerViewSubmissionMCQState();
}

class _LecturerViewSubmissionMCQState extends State<LecturerViewSubmissionMCQ> {
  bool isLoading = true;
