...
class LecturerAssessmentQuestionBankAddEssay extends StatefulWidget {
  @override
  ...
  _LecturerAssessmentQuestionBankAddEssayState createState() =>
      _LecturerAssessmentQuestionBankAddEssayState();
}

class _LecturerAssessmentQuestionBankAddEssayState
    extends State<LecturerAssessmentQuestionBankAddEssay> {
  bool isLoading = true;
  bool isInitial = true;
  ...
  save_essay() async {
    ...
    var res = await Api().postData(data, "saveEssayQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body;
  ...
  update_essay() async {
    ...
    var res = await Api().postData(data, "updateEssayQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body['success'];
