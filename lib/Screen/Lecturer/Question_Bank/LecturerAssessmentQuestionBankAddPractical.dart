...
class LecturerAssessmentQuestionBankAddPractical extends StatefulWidget {
  @override
  ...
  _LecturerAssessmentQuestionBankAddPracticalState createState() =>
      _LecturerAssessmentQuestionBankAddPracticalState();
}

class _LecturerAssessmentQuestionBankAddPracticalState
    extends State<LecturerAssessmentQuestionBankAddPractical> {
  Dio dio = Dio();
  ...
  save_file() async {
    var upload_file_res = await Api().uploadQBFileToServer(practical_file,
        widget.question_bank_id, 'upload_practical_question_file_bank');
  ...
  save_practical() async {
    ...
    var res = await Api().postData(data, "savePracticalQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body['success'];
  ...
  update_practical() async {
    ...
    var res = await Api().postData(data, "updatePracticalQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body['success'];
