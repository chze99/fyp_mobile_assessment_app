// ignore_for_file: non_constant_identifier_names, must_be_immutable, override_on_non_overriding_member, empty_statements
...
class LecturerAssessmentQuestionBankAddTF extends StatefulWidget {
  @override
  ...
  _LecturerAssessmentQuestionBankAddTFState createState() =>
      _LecturerAssessmentQuestionBankAddTFState();
}

enum TF_answer { yes, no }

class _LecturerAssessmentQuestionBankAddTFState
    extends State<LecturerAssessmentQuestionBankAddTF> {
  bool isLoading = true;
  bool isInitial = true;
  bool tf_found = false;
  var assessment_data;
  ...
  save_tf() async {
    ...
    var res = await Api().postData(data, "saveTFQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body['success'];
  ...
  update_tf() async {
    ...
    var res = await Api().postData(data, "updateTFQuestionBank");
    var body = json.decode(res.body);
    if (body['success'] == true) {
      if (this.mounted) {
        return body['success'];
