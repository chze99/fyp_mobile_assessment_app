...
class LecturerProfileChangePassword extends StatefulWidget {
  @override
  var user_id;
  LecturerProfileChangePassword(this.user_id);
  _LecturerProfileChangePasswordState createState() =>
      _LecturerProfileChangePasswordState();
}

class _LecturerProfileChangePasswordState
    extends State<LecturerProfileChangePassword> {
  String name = "";
  ...
  update_profile() async {
    ...
    var res = await Api().postData(data, "updateLecturerPassword");
    var body = json.decode(res.body);
    if (body['success'] != null) {
      print(body);
      return body['success'];
