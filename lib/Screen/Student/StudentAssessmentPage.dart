...
import 'package:mobile_assessment/Screen/Student/StudentAssessmentViewDetail.dart';
...
class StudentAssessmentPage extends StatefulWidget {
  @override
  _StudentAssessmentPageState createState() => _StudentAssessmentPageState();
}
        ...
        if (this.mounted) {
          setState(() {
            ...
            for (int i = 0; i < question_paper_data['count']; i++) {
              DateTime temp_start = new DateFormat("yyyy-MM-dd hh:mm:ss").parse(
                  question_paper_data[i.toString()]
                          ['question_paper_start_date'] +
                      " " +
                      question_paper_data[i.toString()]
                          ['question_paper_start_time']);
              DateTime temp_end = new DateFormat("yyyy-MM-dd hh:mm:ss").parse(
                  question_paper_data[i.toString()]['question_paper_end_date'] +
                      " " +
                      question_paper_data[i.toString()]
                          ['question_paper_end_time']);
              print(temp_start.toString() + temp_end.toString());
