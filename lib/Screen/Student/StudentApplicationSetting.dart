...
class StudentApplicationSetting extends StatefulWidget {
  @override
  int user_id = 0;
  StudentApplicationSetting(this.user_id);
  _StudentApplicationSettingState createState() =>
      _StudentApplicationSettingState();
}

enum assessment_filter { all, ongoing, history, soon }

class _StudentApplicationSettingState extends State<StudentApplicationSetting> {
  String name = "";
