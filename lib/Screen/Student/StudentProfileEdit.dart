...
class StudentProfileEdit extends StatefulWidget {
  @override
  var user_id;
  StudentProfileEdit(this.user_id);
...
class _StudentProfileEditState extends State<StudentProfileEdit> {
  ...
  load_user_data() async {
    ...
    if (user != null && user != "") {
      ...
      if (body['success'] != null) {
        ...
        print(profile_data);
        email.text = profile_data[0]['student_email'];
        contactnumber.text = profile_data[0]['student_contact_number'];
        realname.text = profile_data[0]['student_name'];
      } else {
  ...
  update_profile() async {
    var data = {
      ...
      'student_name': realname.text,
      'student_email': email.text,
      'student_contact_number': contactnumber.text,
    };
    var res = await Api().postData(data, "updateStudentProfileData");
    var body = json.decode(res.body);
    if (body['success'] != null) {
      print(body);
      return body['success'];
